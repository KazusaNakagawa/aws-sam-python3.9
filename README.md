...
```bash
sam-app-python39$ sam build --use-container
```
...
```bash
sam-app-python39$ sam logs -n StockCheckerFunction --stack-name sam-app-python39 --tail
```
...
```bash
sam-app-python39$ pip install -r tests/requirements.txt --user
# unit test
sam-app-python39$ python -m pytest tests/unit -v
# integration test, requiring deploying the stack first.
# Create the env variable AWS_SAM_STACK_NAME with the name of the stack we are testing
sam-app-python39$ AWS_SAM_STACK_NAME=<stack-name> python -m pytest tests/integration -v
```
...
```bash
aws cloudformation delete-stack --stack-name sam-app-python39
```
